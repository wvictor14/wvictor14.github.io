...
On average, yes... teams this year reported lower scores (average 2019 weekly hex score = 3.09) compared to last year (3.23), **but this decrease in performance was not statistically significant (p<0.05)[^6].** 
...
Given the above assumption, we can attribute the observed variation in weekly team scores can be primarily attributed to variation in route setting difficulty (i.e. how difficult the problems are graded/rated by the organizers)[]
...
[^7]: Adapted ranking plot that I made for [#TidyTuesday](https://twitter.com/victor2wy/status/1141220359305232385)
