...
After a fun 5 weeks, the second season of the **Pacific Boulder League (PBL)** is nearing its end. Three Fridays ago (November 1st) was the Hive Finals for the 3 participating Hive gyms (Vancouver, North Shore, and the newly-opened Surrey location). 
...
Teams must be 4-5 members and co-ed. They have to climb 5 of 20 problems each week. Scores are determined by the difficulty of the climbs completed. Here is an example score card of one of my the week's for our team:
...
Weekly rankings of teams are determined by a cumulative total of all previous weeks.

When possible, I converted *Weekly PBL cores* to  *Average Hex Scores*, which is a more relevant measure of difficulty that us Hive climbers can relate to. It's simply the *Weekly PBL score* divided by the *total number of boulders climbed* (which is 5).
